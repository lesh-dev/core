...
class TestSpeed(unittest.TestCase):
    ...
    def test_notification_list(cls):
        with yasm.test_request_context():
            time = timeit.timeit(notification_list, number=100)
    ...
    def test_department_list(cls):
        with yasm.test_request_context():
            time = timeit.timeit(department_list, number=100)
            test_case = sys._getframe().f_code.co_name
            results_file = open("results")
            results = json.load(results_file)
            results_file.close()
    ...
    def test_person_list(cls):
        with yasm.test_request_context():
            time = timeit.timeit(person_list, number=100)
            test_case = sys._getframe().f_code.co_name
            results_file = open("results")
            results = json.load(results_file)
            results_file.close()
    ...
    def test_contact_list(cls):
        with yasm.test_request_context():
            time = timeit.timeit(contact_list, number=100)
            test_case = sys._getframe().f_code.co_name
            results_file = open("results")
            results = json.load(results_file)
            results_file.close()
    ...
    def test_school_list(cls):
        with yasm.test_request_context():
            time = timeit.timeit(school_list, number=100)
            test_case = sys._getframe().f_code.co_name
            results_file = open("results")
            results = json.load(results_file)
            results_file.close()
    ...
    def test_course_list(cls):
        with yasm.test_request_context():
            time = timeit.timeit(course_list, number=100)
            test_case = sys._getframe().f_code.co_name
            results_file = open("results")
            results = json.load(results_file)
            results_file.close()
    ...
    def test_course_teachers_list(cls):
        with yasm.test_request_context():
            time = timeit.timeit(course_teachers_list, number=100)
            test_case = sys._getframe().f_code.co_name
            results_file = open("results")
            results = json.load(results_file)
            results_file.close()
    ...
    def test_exam_list(cls):
        with yasm.test_request_context():
            time = timeit.timeit(exam_list, number=100)
            test_case = sys._getframe().f_code.co_name
            results_file = open("results")
            results = json.load(results_file)
            results_file.close()
    ...
    def test_person_school_list(cls):
        with yasm.test_request_context():
            time = timeit.timeit(person_school_list, number=100)
            test_case = sys._getframe().f_code.co_name
            results_file = open("results")
            results = json.load(results_file)
            results_file.close()
    ...
    def test_person_comment_list(cls):
        with yasm.test_request_context():
            time = timeit.timeit(person_comment_list, number=100)
            test_case = sys._getframe().f_code.co_name
            results_file = open("results")
            results = json.load(results_file)
            results_file.close()
    ...
    def test_submission_list(cls):
        with yasm.test_request_context():
            time = timeit.timeit(submission_list, number=100)
            test_case = sys._getframe().f_code.co_name
            results_file = open("results")
            results = json.load(results_file)
            results_file.close()
    ...
    def test_contestants_list(cls):
        with yasm.test_request_context():
            time = timeit.timeit(contestants_list, number=100)
            test_case = sys._getframe().f_code.co_name
            results_file = open("results")
            results = json.load(results_file)
            results_file.close()
    ...
    def test_problems_list(cls):
        with yasm.test_request_context():
            time = timeit.timeit(problems_list, number=100)
            test_case = sys._getframe().f_code.co_name
            results_file = open("results")
            results = json.load(results_file)
            results_file.close()
    ...
    def test_solutions_list(cls):
        with yasm.test_request_context():
            time = timeit.timeit(solutions_list, number=100)
            test_case = sys._getframe().f_code.co_name
            results_file = open("results")
            results = json.load(results_file)
            results_file.close()
