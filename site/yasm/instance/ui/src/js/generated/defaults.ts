...
export const default_Person = {
    ...
    department_id: 0,
    department_id_fk: default_Department,
...
export const default_CourseTeachers = {
    ...
    course_id: 0,
    course_id_fk: default_Course,
    course_teacher_id: 0,
    course_teacher_id_fk: default_Person,
...
export const default_Exam = {
    exam_id: 0,
    student_person_id: 0,
    student_person_id_fk: default_Person,
    course_id: 0,
    course_id_fk: default_Course,
...
export const default_PersonSchool = {
    person_school_id: 0,
    member_person_id: 0,
    member_person_id_fk: default_Person,
    member_department_id: 0,
    member_department_id_fk: default_Department,
    school_id: 0,
    school_id_fk: default_School,
    is_student: "is_student",
    is_teacher: "is_teacher",
...
export const default_PersonComment = {
    ...
    blamed_person_id: 0,
    blamed_person_id_fk: default_Person,
    school_id: 0,
    school_id_fk: default_School,
...
export const default_Solutions = {
    solutions_id: 0,
    problem_id: 0,
    problem_id_fk: default_Problems,
    contest_year: "contest_year",
    contestant_id: 0,
    contestant_id_fk: default_Contestants,
