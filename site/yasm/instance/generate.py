...
def main():
    ...
    def gen_backend_speedtests():
        ...
        for name, fields in models.items():
            ...
            tests.write('            login_user(user=instance.login.controllers.load_user(467))\n')
            tests.write('            time = timeit.timeit({name}, number=10)\n'.format(name=scl(name)))
            ...
            tests.write('                if time < results[test_case]:\n')
