...
(function($) {
    $.flexbox = function(div, o) {
        ...
        var $row_tag;
        if (o.isTabled) {
            var $tbl = $('<table></table>').appendTo($ctr);
            $content = $('<tbody></tbody>').appendTo($tbl);

            $row_tag = 'tr';
        } else {
            $content = $('<div></div>').appendTo($ctr);
            $row_tag = 'div';
        }
        ...
        function displayItems(d, q) {
            ...
            $content
				.children($row_tag + '.' + 'row')
				.mouseover(function() {
				    $content.children($row_tag + '.' + 'row').removeClass(o.selectClass);
        ...
        function getCurr() {
            ...
            var $curr = $content.children('*.' + o.selectClass);
        ...
        function nextPage() {
            ...
            if ($curr && $curr.next().length > 0) {
                ...
                $content.children($row_tag + ':first-child').addClass(o.selectClass);
        }
        ...
        function prevPage() {
            ...
            if ($curr && $curr.prev().length > 0) {
                ...
                $content.children($row_tag + ':last-child').addClass(o.selectClass);
        }
    ...
    $.fn.flexbox.defaults = {
        ...
        width: 500, // total width of flexbox.  auto-adjusts based on showArrow value
        ...
        isTabled: false // if true content is a table
    };
