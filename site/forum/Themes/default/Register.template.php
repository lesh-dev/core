...
<form action="', $scripturl, '?action=register2" method="post" accept-charset="', $context['character_set'], '" name="creator" id="creator" onsubmit="return verifyAgree();">
	...
	echo '
					...
					<tr>
						<td width="40%">
							<b>', $txt['RealName'], ':</b>
							<div class="smalltext">', $txt['RealNameDesc'], '</div>
						</td>
						<td>
							<input type="text" name="realName" size="40" tabindex="', $context['tabindex']++, '"/>
						</td>
					</tr>
					<tr>
						<td width="40%">
	...
	$nQI = mt_rand(0,1000000) % count($aRegQuestions);
	echo '<tr><td width="40%">
							<b>', $txt['RegQuestion'], ':</b>
						</td>
						<td>
							<span class="smalltext">', $aRegQuestions[$nQI], '</span><br />
							<input type="text" name="regAnswer" size="30" tabindex="', $context['tabindex']++, '" />
							<input type="hidden" name="regQuestionIndex" size="30" value="', $nQI, '"/>
						</td>
					</tr>';
