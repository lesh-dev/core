	...
	if ($context['simple_search'])
	{
		echo '<b>', $txt[582], ':</b><br />
					<table border="0" cellpadding="5" cellspacing="0"><tr>
						<td><input type="text" name="search"', !empty($context['search_params']['search']) ?
							' value="' . $context['search_params']['search'] . '"' : '', ' size="40" /></td>
						<td>&nbsp;';
						makeSubmit('FormSearch', 100, $txt[182]);
						echo '</td>
					</tr>';
		echo "<script>ButtonCreate('FormSearch', 'search');</script>";
