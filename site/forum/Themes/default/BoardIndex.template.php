	...
	<table border="0" width="100%" cellspacing="0" cellpadding="5">
		<tr>
			<td align="', !$context['right_to_left'] ? 'left' : 'right', '" class="smalltext">
				<img src="' . $settings['images_url'] . '/new_some.png" alt="" align="middle" /> ', $txt[333], '
				<img src="' . $settings['images_url'] . '/new_none.png" alt="" align="middle" style="margin-left: 4ex;" /> ', $txt[334], '
			</td>
					...
					<td class="windowbg2" valign="middle">
						<form action="', $scripturl, '?action=login2" method="post" accept-charset="', $context['character_set'], '" style="margin: 0;">
							<table border="0" cellpadding="2" cellspacing="0" align="center" width="100%"><tr>
								...
								<td valign="middle" align="left">';
								makeSubmit('BoardIndexLogin', 100, $txt[34]);
								echo '</td>
							</tr></table>
						</form>
					</td>
				</tr>';
		echo '<script>ButtonCreate("BoardIndexLogin", "login");</script>';
	}
