...
// ---------------------------------------------------
$txt['RegQuestion'] = 'Spam protection question';
$txt['RegQuestionCheckFailed'] = 'Given answer is wrong. The anwers are not case-sensitive. Some questions allow several possible answers. Please think more and try again.';

$txt['RealName'] = 'Real Name';
$txt['RealNameDesc'] = 'Your real name is required to be identified by Core ';
$txt['RealNameCheckFailed'] = 'Your real name cannot be so short. Please think more and try again.';
