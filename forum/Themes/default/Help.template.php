...
//]]>
	...
	else
	{
		...
		if (file_exists($settings['theme_dir'] . '/images/' . $context['user']['language'] . '/new_some.png'))
			echo '
				<img src="', $settings['images_url'], '/', $context['user']['language'], '/new_some.png" alt="', $txt['manual_index_new_posts'], '" border="0" />&nbsp;&nbsp;<img src="', $settings['images_url'], '/', $context['user']['language'], '/new_none.png" alt="', $txt['manual_index_no_new'], '" border="0" />';
		else
			echo '
