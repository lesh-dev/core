...
function template_login()
{
	...
	makeSubmit('BasicLogin', 100, $txt[34]);
	echo '</td>
				</tr><tr class="windowbg">
		...
		echo '<script>ButtonCreate("BasicLogin", "login");</script>';
...
function template_kick_guest()
{
	...
	echo '
					...
					<td class="windowbg">
						<table border="0" cellpadding="3" cellspacing="0" align="center">
							<tr>
								...
								<td align="center" colspan="2">';
							makeSubmit('AltLogin', 100, $txt[34]);
							echo '</td>
							</tr><tr>
								<td align="center" colspan="2" class="smalltext"><a href="', $scripturl, '?action=reminder">', $txt[315], '</a><br /><br /></td>
							</tr>
		...
		echo '<script>ButtonCreate("AltLogin", "login");</script>';
			...
			<td colspan="2" class="windowbg">
				<table border="0" width="90%" align="center">
					<tr>
						...
						makeSubmit('AnotherLogin', 100, $txt[34]);
					echo '</td>
					</tr>
				</table>
			</td>
...
echo '<script>ButtonCreate("AnotherLogin", "login");</script>';
}
	...
	echo '
		<tr class="windowbg">
			<td align="center" style="padding: 1ex 0;">
				<b>', $txt[36], ':</b> <input type="password" name="admin_pass" size="24" /> <a href="', $scripturl,
					'?action=helpadmin;help=securityDisable_why" onclick="return reqWin(this.href);" class="help"><img src="',
					$settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="middle" /></a><br />';
				makeSubmit('AdminLogin', 100, $txt[34]);
				echo '</td>
		</tr>
	</table>';
	echo '<script>ButtonCreate("AdminLogin", "login");</script>';
