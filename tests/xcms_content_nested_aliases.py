...
class XcmsContentNestedAliases(xtest_common.XcmsTest):
    ...
    def run(self):
        ...
        inpPageDir1 = "nested_alias1_" + random_crap.randomText(4)
        inpMenuTitle1 = "nested_alias1_" + random_crap.randomText(4)
        inpPageHeader1 = "nested_alias1_" + random_crap.randomText(4)
        inpAlias1 = "nested_alias_" + random_crap.randomText(4) + "/level1"
        ...
        inpPageDir2 = "nested_alias2_" + random_crap.randomText(4)
        inpMenuTitle2 = "nested_alias2_" + random_crap.randomText(4)
        inpPageHeader2 = "nested_alias2_" + random_crap.randomText(4)
        ...
        self.gotoAlias(inpAlias1)
        self.assertSitePageHeader(inpPageHeader1)
        self.gotoAlias(inpAlias2)
